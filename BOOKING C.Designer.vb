...
Partial Class BOOKING_C
    ...
    Private Sub InitializeComponent()
        ...
        Label3.Location = New Point(300, 304)
        Label3.Name = "Label3"
        ...
        Panel2.Location = New Point(143, 327)
        Panel2.Name = "Panel2"
        Panel2.Size = New Size(357, 136)
        Panel2.TabIndex = 8
        ' 
        ' RadioButton10
        ' 
        ...
        RadioButton10.Location = New Point(104, 99)
        ...
        RadioButton8.Location = New Point(283, 62)
        ...
        RadioButton7.Location = New Point(200, 62)
        ...
        RadioButton6.Location = New Point(104, 62)
        ...
        RadioButton4.Location = New Point(283, 23)
        ...
        RadioButton3.Location = New Point(200, 23)
        ...
        RadioButton2.Location = New Point(104, 23)
        ...
        ' MonthCalendar1
        ' 
        MonthCalendar1.Location = New Point(217, 133)
        MonthCalendar1.Name = "MonthCalendar1"
        MonthCalendar1.TabIndex = 7
        ' 
        ' Panel1
        ' 
        Panel1.Controls.Add(btnBookC)
        ...
        ' btnBookC
        ' 
        btnBookC.Cursor = Cursors.Hand
        btnBookC.Location = New Point(207, 55)
        btnBookC.Name = "btnBookC"
        btnBookC.Size = New Size(75, 23)
        btnBookC.TabIndex = 1
        btnBookC.Text = "BOOK"
        ToolTip1.SetToolTip(btnBookC, "Click here to book your aapointment")
        btnBookC.UseVisualStyleBackColor = True
        ' 
        ' PictureBox2
        ' 
        ...
        Label1.TabIndex = 2
        Label1.Text = "Dr Njongo" & vbCrLf & "Cardiologist"
        ' 
        ' PictureBox1
        ' 
        PictureBox1.Image = My.Resources.Resources.cardiologist
        ...
        ' btnSubmitC
        ' 
        btnSubmitC.Cursor = Cursors.Hand
        btnSubmitC.Location = New Point(561, 433)
        btnSubmitC.Name = "btnSubmitC"
        btnSubmitC.Size = New Size(75, 23)
        btnSubmitC.TabIndex = 11
        btnSubmitC.Text = "SUBMIT"
        ToolTip1.SetToolTip(btnSubmitC, "Click to submit")
        btnSubmitC.UseVisualStyleBackColor = True
        ' 
        ' btnHome
        ' 
        btnHome.Cursor = Cursors.Hand
        btnHome.Location = New Point(19, 20)
        btnHome.Name = "btnHome"
        btnHome.Size = New Size(78, 23)
        btnHome.TabIndex = 12
        btnHome.Text = "HOME"
    ...
    Friend WithEvents btnSubmitC As Button
