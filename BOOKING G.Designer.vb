...
Partial Class BOOKING_G
    ...
    Private Sub InitializeComponent()
        ...
        Label3.Location = New Point(297, 301)
        Label3.Name = "Label3"
        ...
        Label2.Location = New Point(453, 140)
        Label2.Name = "Label2"
        ...
        Panel2.Location = New Point(156, 328)
        Panel2.Name = "Panel2"
        Panel2.Size = New Size(349, 136)
        Panel2.TabIndex = 13
        ...
        RadioButton8.Location = New Point(275, 62)
        ...
        RadioButton7.Location = New Point(187, 62)
        ...
        RadioButton4.Location = New Point(275, 23)
        ...
        RadioButton3.Location = New Point(187, 23)
        ...
        ' MonthCalendar1
        ' 
        MonthCalendar1.Location = New Point(214, 130)
        MonthCalendar1.Name = "MonthCalendar1"
        MonthCalendar1.TabIndex = 12
        ' 
        ' Panel1
        ' 
        Panel1.Controls.Add(btnBookG)
        Panel1.Controls.Add(PictureBox2)
        Panel1.Controls.Add(Label1)
        Panel1.Controls.Add(PictureBox1)
        Panel1.Location = New Point(175, 40)
        Panel1.Name = "Panel1"
        ...
        ' btnBookG
        ' 
        btnBookG.Cursor = Cursors.Hand
        btnBookG.Location = New Point(207, 55)
        btnBookG.Name = "btnBookG"
        btnBookG.Size = New Size(75, 23)
        btnBookG.TabIndex = 1
        btnBookG.Text = "BOOK"
        ToolTip1.SetToolTip(btnBookG, "Click here to book your appointment")
        btnBookG.UseVisualStyleBackColor = True
        ' 
        ' PictureBox2
        ' 
        ...
        Label1.TabIndex = 2
        Label1.Text = "Dr Lefty" & vbCrLf & "General"
        ' 
        ' PictureBox1
        ' 
        PictureBox1.Image = My.Resources.Resources.doctor__1_
        ...
        ' btnSubmitG
        ' 
        btnSubmitG.Cursor = Cursors.Hand
        btnSubmitG.Location = New Point(611, 441)
        btnSubmitG.Name = "btnSubmitG"
        btnSubmitG.Size = New Size(75, 23)
        btnSubmitG.TabIndex = 16
        btnSubmitG.Text = "SUBMIT"
        ToolTip1.SetToolTip(btnSubmitG, "Click to submit")
        btnSubmitG.UseVisualStyleBackColor = True
        ' 
        ' btnHome
        ' 
        btnHome.Location = New Point(19, 27)
        btnHome.Name = "btnHome"
        btnHome.Size = New Size(80, 23)
        btnHome.TabIndex = 17
        btnHome.Text = "HOME"
        ...
        ' btnCancel
        ' 
        btnCancel.Location = New Point(611, 397)
        ...
        ClientSize = New Size(717, 484)
        Controls.Add(btnCancel)
        Controls.Add(btnHome)
        Controls.Add(btnSubmitG)
        Controls.Add(Label3)
        Controls.Add(Label2)
        Controls.Add(Panel2)
    ...
    Friend WithEvents btnBookG As Button
    Friend WithEvents PictureBox2 As PictureBox
    Friend WithEvents Label1 As Label
    Friend WithEvents PictureBox1 As PictureBox
    Friend WithEvents btnSubmitG As Button
