...
Partial Class BOOKING_M
    ...
    Private Sub InitializeComponent()
        ...
        Label3.Location = New Point(306, 292)
        Label3.Name = "Label3"
        ...
        Label2.Location = New Point(462, 131)
        Label2.Name = "Label2"
        ...
        Panel2.Location = New Point(162, 319)
        Panel2.Name = "Panel2"
        ...
        ToolTip1.SetToolTip(RadioButton9, "Pick your time")
        ...
        RadioButton6.Location = New Point(96, 62)
        RadioButton6.Name = "RadioButton6"
        RadioButton6.Size = New Size(62, 24)
        RadioButton6.TabIndex = 5
        RadioButton6.TabStop = True
        RadioButton6.Text = "10:35"
        ToolTip1.SetToolTip(RadioButton6, "Pick your time")
        ...
        ToolTip1.SetToolTip(RadioButton5, "Pick your time")
        ...
        RadioButton4.Location = New Point(264, 23)
        RadioButton4.Name = "RadioButton4"
        RadioButton4.Size = New Size(62, 24)
        RadioButton4.TabIndex = 3
        RadioButton4.TabStop = True
        RadioButton4.Text = "09:35"
        ToolTip1.SetToolTip(RadioButton4, "Pick your time")
        ...
        RadioButton3.Location = New Point(182, 23)
        RadioButton3.Name = "RadioButton3"
        RadioButton3.Size = New Size(62, 24)
        RadioButton3.TabIndex = 2
        RadioButton3.TabStop = True
        RadioButton3.Text = "09:00"
        ToolTip1.SetToolTip(RadioButton3, "Pick your time")
        ...
        RadioButton2.Location = New Point(96, 23)
        RadioButton2.Name = "RadioButton2"
        RadioButton2.Size = New Size(62, 24)
        RadioButton2.TabIndex = 1
        RadioButton2.TabStop = True
        RadioButton2.Text = "08:30"
        ToolTip1.SetToolTip(RadioButton2, "Pick your time")
        ...
        ToolTip1.SetToolTip(RadioButton1, "Pick your time")
        RadioButton1.UseVisualStyleBackColor = True
        ' 
        ' MonthCalendar1
        ' 
        MonthCalendar1.Location = New Point(223, 121)
        MonthCalendar1.Name = "MonthCalendar1"
        MonthCalendar1.TabIndex = 12
        ' 
        ' Panel1
        ' 
        Panel1.Controls.Add(btnBookM)
        Panel1.Controls.Add(PictureBox2)
        Panel1.Controls.Add(Label1)
        Panel1.Controls.Add(PictureBox1)
        Panel1.Location = New Point(184, 31)
        Panel1.Name = "Panel1"
        ...
        ' btnBookM
        ' 
        btnBookM.Cursor = Cursors.Hand
        btnBookM.Location = New Point(207, 55)
        btnBookM.Name = "btnBookM"
        btnBookM.Size = New Size(75, 23)
        btnBookM.TabIndex = 1
        btnBookM.Text = "BOOK"
        ToolTip1.SetToolTip(btnBookM, "Click here to book your appointment")
        btnBookM.UseVisualStyleBackColor = True
        ' 
        ' PictureBox2
        ' 
        ...
        Label1.TabIndex = 2
        Label1.Text = "Dr Ban ban" & vbCrLf & "Medical Doctor"
        ' 
        ' PictureBox1
        ' 
        PictureBox1.Image = My.Resources.Resources.doctor__2_
        ...
        ' btnSubmitM
        ' 
        btnSubmitM.Cursor = Cursors.Hand
        btnSubmitM.Location = New Point(592, 432)
        btnSubmitM.Name = "btnSubmitM"
        btnSubmitM.Size = New Size(75, 23)
        btnSubmitM.TabIndex = 16
        btnSubmitM.Text = "SUBMIT"
        ToolTip1.SetToolTip(btnSubmitM, "Click to submit")
        btnSubmitM.UseVisualStyleBackColor = True
        ' 
        ' btnHome
        ' 
        btnHome.Location = New Point(22, 17)
        ...
        ClientSize = New Size(713, 477)
        Controls.Add(btnHome)
        Controls.Add(btnSubmitM)
        Controls.Add(Label3)
        Controls.Add(Label2)
        Controls.Add(Panel2)
    ...
    Friend WithEvents btnBookM As Button
    Friend WithEvents PictureBox2 As PictureBox
    Friend WithEvents Label1 As Label
    Friend WithEvents PictureBox1 As PictureBox
    Friend WithEvents btnSubmitM As Button
